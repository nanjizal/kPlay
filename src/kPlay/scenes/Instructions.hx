...
class Instructions {
    public static function scene(){
        var scene = new Scene( 'instructions' );
        scene.addImage( new Picture( Assets.images.sunset));
        ...
        var tx = new Label( "Instructions", SceneProps.regular, SceneProps.black, SceneProps.headerSize - 4, 2, px, py + 2 );
